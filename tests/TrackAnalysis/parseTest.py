...
def test():
    ...
    cmd = r"'C:/Program Files/MKVToolNix/mkvmerge.exe' --ui-language en --output 'J:\Example\TestMedia\Example 09\Angelic Later (2001)\Season 01\Kidou Tenshi Angelic Layer - S01E01 (1).mkv' --no-video --language 1:jpn --default-track 1:yes --language 2:eng --sub-charset 3:UTF-8 --language 3:eng --default-track 3:yes '(' 'J:\Example\TestMedia\Example 09\Source 01\Kidou Tenshi Angelic Layer - S01E01.mkv' ')' --no-audio --no-subtitles --no-chapters --language 0:jpn --display-dimensions 0:1280x960 '(' 'J:\Example\TestMedia\Example 09\Source 02\[Kira-Fansub] Kidou Tenshi Angelic Layer ep 01v2 (BD H264 1280x960 24fps AAC) [C7E321E0].mkv' ')' --title 'Encoded By Cleo' --track-order 1:0,0:1,0:2,0:3"
