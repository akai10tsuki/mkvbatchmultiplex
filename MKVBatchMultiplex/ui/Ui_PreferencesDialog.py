...
class Ui_PreferencesDialog(object):
    def setupUi(self, PreferencesDialog):
        ...
        PreferencesDialog.resize(744, 484)
        font = QFont()
        ...
        self.chkBoxRestoreWindowSize.setGeometry(QRect(20, 260, 641, 27))
        ...
        self.frame.setGeometry(QRect(10, 202, 621, 41))
