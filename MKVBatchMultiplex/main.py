...
from vsutillib.pyqt import centerWidgets, QActionWidget, QMenuWidget
...
class MainWindow(QMainWindow):  # pylint: disable=R0902
    ...
    def _initHelper(self):
        ...
        self.tableModel.insertRows(0, 5, data=data)
